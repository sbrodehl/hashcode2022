...
The Online Qualifications Livestream was available [here](https://youtu.be/yfXu9_Za_mg).

> _Text / images (except `# Scores`) is taken verbatim from the 'Qualification Round - Hash Code 2022' [website](https://codingcompetitions.withgoogle.com/hashcode/round/00000000008caae7/000000000098afc8)._

## Problem

![Picture with four laptops and letters T E A M illustrating teamwork](assets/team.png)
...
![Three contributors and their skills, as described in the example above.](assets/contributors.png)
...
![The 3 roles that need to be filled for project WebServer, as described in the example above.](assets/roles.png)
...
- have the skill at exactly one level below the required level, **only if another contributor on the same project (assigned to another role), has this skill at the required level or higher**.
  In this case, the contributor will be mentored by their colleague :)

One contributor can mentor multiple people at once, including for the same skill.
A contributor can mentor and be mentored by other contributors at the same time.

Not possessing a skill is equivalent to possessing a skill at level 0.
So a contributor can work on a project and be assigned to a role with requirement C++ level 1 if they don’t know any C++, provided that somebody else on the team knows C++ at level 1 or higher.
...
Each contributor can start working on day 0 and can be working on at most one project at the same time.
Once the work on a project starts, its contributors will be working on it the number of days equal to its duration and then become available to work on other projects.
...
| Input Data                                                  | Contributors | Projects | Roles |
|-------------------------------------------------------------|--------------|----------|-------|
| [A - An example](input/a_an_example.in.txt)                 | 3            | 3        | 4     |
| [B - Better start small](input/b_better_start_small.in.txt) | 50           | 100      | 36    |
| [C - Collaboration](input/c_collaboration.in.txt)           | 1500         | 1000     | 200   |
| [D - Dense schedule](input/d_dense_schedule.in.txt)         | 500          | 1000     | 188   |
| [E - Exceptional skills](input/e_exceptional_skills.in.txt) | 800          | 10000    | 800   |
| [F - Find great mentors](input/f_find_great_mentors.in.txt) | 1000         | 19413    | 500   |
...
![Three contributors and their skills, as described in the input above.](assets/input_contributors.png)
![The 3 projects that are described in the input.](assets/input_projects.png)
...
If one contributor is assigned to multiple projects, the contributor will work on them in the same order as they appear in the submission file.
Each project starts immediately on the first day on which all the assigned contributors are available.

![Projects execution timeline based on the input data set and the submission from the previous sections.](assets/schedule.png)
...
The submission scored **33** points.
...
The submission scored **800,991** points.
Insights about this submission:

- projects completed: 73 (73% of all projects)
- projects completed before their "best before" time in days (scoring full points): 73 (73% of all projects)
- projects completed but scoring 0 points (because they were completed too long after their "best before" time): 0 (0% of all projects)
- number of times a contributor got mentored on a project: 5
- number of times a contributor increased their skill level thanks to completing a project: 79
...
- projects completed: 1000 (100% of all projects)
- projects completed before their "best before" time in days (scoring full points): 32 (3% of all projects)
- projects completed but scoring 0 points (because they were completed too long after their "best before" time): 952 (95% of all projects)
- number of times a contributor got mentored on a project: 0
...
The submission scored **173,626** points.
Insights about this submission:

- projects completed: 113 (11% of all projects)
- projects completed before their "best before" time in days (scoring full points): 113 (11% of all projects)
- projects completed but scoring 0 points (because they were completed too long after their "best before" time): 0 (0% of all projects)
- number of times a contributor got mentored on a project: 6
- number of times a contributor increased their skill level thanks to completing a project: 328
...
- projects completed before their "best before" time in days (scoring full points): 5897 (58% of all projects)
- projects completed but scoring 0 points (because they were completed too long after their "best before" time): 86 (0% of all projects)
- number of times a contributor got mentored on a project: 0
